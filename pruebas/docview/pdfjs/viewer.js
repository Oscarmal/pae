...
//##################
// O3M
//Recuperación de parametros enviados
var params =
document.getElementById("identificador_js").src.match(/archivo=(ftp|http|https|)(:\/\/|)(\w+:{0,1}\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?/gi);
var archivo = params[0].split("=");
// alert(archivo[1]);
var ARCHIVO = archivo[1];
//##################

'use strict';

var DEFAULT_URL = ARCHIVO;

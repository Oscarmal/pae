...
/*Prueba local*/
define("SERVER","192.168.231.25"); //Cable
// define("SERVER","192.168.231.38"); //Wi-Fi
define("PORT",21); //Puerto
define("USER","ftp_test"); //Nombre de Usuario
define("PASSWORD","1234"); //Contraseña de acceso
...
if($connFTP=@ftp_connect(SERVER,PORT)){ //Obtiene un manejador del Servidor FTP
...
//Sube archivo de la maquina Cliente al Servidor (Comando PUT)
	if($connFTP=@ConectFTP()){ //Obtiene un manejador y se conecta al Servidor FTP
		if($ftp=@ftp_put($connFTP,$ServerFile,$LocalFile,FTP_BINARY)){ //Sube archivo al Servidor FTP en modo Binario
			return $ftp;
		}

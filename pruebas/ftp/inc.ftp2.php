...
/*Prueba local*/
// define("SERVER","192.168.231.25"); //IP o Nombre del Servidor
define("SERVER","192.168.231.38"); //IP o Nombre del Servidor
...
//Sube archivo de la maquina Cliente al Servidor (Comando PUT)
	...
	$ftp=ftp_put($connFTP,$ServerFile,$LocalFile,FTP_ASCII); //Sube archivo al Servidor FTP en modo Binario			return $ftp;
